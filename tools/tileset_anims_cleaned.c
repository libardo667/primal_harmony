...
u16 *const gTilesetAnims_Mauville_Flower1_VDests[] = {
    (u16 *)(0x06000000 + ((512 + 96) * 32)),
    (u16 *)(0x06000000 + ((512 + 100) * 32)),
    (u16 *)(0x06000000 + ((512 + 104) * 32)),
    (u16 *)(0x06000000 + ((512 + 108) * 32)),
    (u16 *)(0x06000000 + ((512 + 112) * 32)),
    (u16 *)(0x06000000 + ((512 + 116) * 32)),
    (u16 *)(0x06000000 + ((512 + 120) * 32)),
    (u16 *)(0x06000000 + ((512 + 124) * 32))
};

u16 *const gTilesetAnims_Mauville_Flower2_VDests[] = {
    (u16 *)(0x06000000 + ((512 + 128) * 32)),
    (u16 *)(0x06000000 + ((512 + 132) * 32)),
    (u16 *)(0x06000000 + ((512 + 136) * 32)),
    (u16 *)(0x06000000 + ((512 + 140) * 32)),
    (u16 *)(0x06000000 + ((512 + 144) * 32)),
    (u16 *)(0x06000000 + ((512 + 148) * 32)),
    (u16 *)(0x06000000 + ((512 + 152) * 32)),
    (u16 *)(0x06000000 + ((512 + 156) * 32))
};
...
u16 *const gTilesetAnims_EverGrande_VDests[] = {
    (u16 *)(0x06000000 + ((512 + 224) * 32)),
    (u16 *)(0x06000000 + ((512 + 228) * 32)),
    (u16 *)(0x06000000 + ((512 + 232) * 32)),
    (u16 *)(0x06000000 + ((512 + 236) * 32)),
    (u16 *)(0x06000000 + ((512 + 240) * 32)),
    (u16 *)(0x06000000 + ((512 + 244) * 32)),
    (u16 *)(0x06000000 + ((512 + 248) * 32)),
    (u16 *)(0x06000000 + ((512 + 252) * 32))
};
...
{
    u16 i = timer % (sizeof(gTilesetAnims_General_Flower) / sizeof((gTilesetAnims_General_Flower)[0]));
...
{
    u8 i = timer % (sizeof(gTilesetAnims_General_Water) / sizeof((gTilesetAnims_General_Water)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_General_Water[i], (u16 *)(0x06000000 + ((432) * 32)), 30 * 32);
}

static void QueueAnimTiles_General_SandWaterEdge(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_General_SandWaterEdge) / sizeof((gTilesetAnims_General_SandWaterEdge)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_General_SandWaterEdge[i], (u16 *)(0x06000000 + ((464) * 32)), 10 * 32);
}

static void QueueAnimTiles_General_Waterfall(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_General_Waterfall) / sizeof((gTilesetAnims_General_Waterfall)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_General_Waterfall[i], (u16 *)(0x06000000 + ((496) * 32)), 6 * 32);
}
...
{
    u16 i = timer % (sizeof(gTilesetAnims_General_LandWaterEdge) / sizeof((gTilesetAnims_General_LandWaterEdge)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_General_LandWaterEdge[i], (u16 *)(0x06000000 + ((480) * 32)), 10 * 32);
}

static void QueueAnimTiles_Lavaridge_Steam(u8 timer)
{
    u8 i = timer % (sizeof(gTilesetAnims_Lavaridge_Steam) / sizeof((gTilesetAnims_Lavaridge_Steam)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Steam[i], (u16 *)(0x06000000 + ((512 + 288) * 32)), 4 * 32);

    i = (timer + 2) % (int)(sizeof(gTilesetAnims_Lavaridge_Steam) / sizeof((gTilesetAnims_Lavaridge_Steam)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Steam[i], (u16 *)(0x06000000 + ((512 + 292) * 32)), 4 * 32);
}

static void QueueAnimTiles_Pacifidlog_LogBridges(u8 timer)
{
    u8 i = timer % (sizeof(gTilesetAnims_Pacifidlog_LogBridges) / sizeof((gTilesetAnims_Pacifidlog_LogBridges)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_Pacifidlog_LogBridges[i], (u16 *)(0x06000000 + ((512 + 464) * 32)), 30 * 32);
}

static void QueueAnimTiles_Underwater_Seaweed(u8 timer)
{
    u8 i = timer % (sizeof(gTilesetAnims_Underwater_Seaweed) / sizeof((gTilesetAnims_Underwater_Seaweed)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_Underwater_Seaweed[i], (u16 *)(0x06000000 + ((512 + 496) * 32)), 4 * 32);
}

static void QueueAnimTiles_Pacifidlog_WaterCurrents(u8 timer)
{
    u8 i = timer % (sizeof(gTilesetAnims_Pacifidlog_WaterCurrents) / sizeof((gTilesetAnims_Pacifidlog_WaterCurrents)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_Pacifidlog_WaterCurrents[i], (u16 *)(0x06000000 + ((512 + 496) * 32)), 8 * 32);
}

static void QueueAnimTiles_Mauville_Flowers(u16 timer_div, u8 timer_mod)
{
    timer_div -= timer_mod;
    if (timer_div < min((sizeof(gTilesetAnims_Mauville_Flower1) / sizeof((gTilesetAnims_Mauville_Flower1)[0])), (sizeof(gTilesetAnims_Mauville_Flower2) / sizeof((gTilesetAnims_Mauville_Flower2)[0]))))
    {
        timer_div %= min((sizeof(gTilesetAnims_Mauville_Flower1) / sizeof((gTilesetAnims_Mauville_Flower1)[0])), (sizeof(gTilesetAnims_Mauville_Flower2) / sizeof((gTilesetAnims_Mauville_Flower2)[0])));
        AppendTilesetAnimToBuffer(gTilesetAnims_Mauville_Flower1[timer_div], gTilesetAnims_Mauville_Flower1_VDests[timer_mod], 4 * 32);
        AppendTilesetAnimToBuffer(gTilesetAnims_Mauville_Flower2[timer_div], gTilesetAnims_Mauville_Flower2_VDests[timer_mod], 4 * 32);
    }
    else
    {
        timer_div %= min((sizeof(gTilesetAnims_Mauville_Flower1_B) / sizeof((gTilesetAnims_Mauville_Flower1_B)[0])), (sizeof(gTilesetAnims_Mauville_Flower2_B) / sizeof((gTilesetAnims_Mauville_Flower2_B)[0])));
        AppendTilesetAnimToBuffer(gTilesetAnims_Mauville_Flower1_B[timer_div], gTilesetAnims_Mauville_Flower1_VDests[timer_mod], 4 * 32);
        AppendTilesetAnimToBuffer(gTilesetAnims_Mauville_Flower2_B[timer_div], gTilesetAnims_Mauville_Flower2_VDests[timer_mod], 4 * 32);
    }
}
...
{
    timer_div -= timer_mod;
    timer_div %= (sizeof(gTilesetAnims_Rustboro_WindyWater) / sizeof((gTilesetAnims_Rustboro_WindyWater)[0]));
    if (gTilesetAnims_Rustboro_WindyWater[timer_div])
        AppendTilesetAnimToBuffer(gTilesetAnims_Rustboro_WindyWater[timer_div], gTilesetAnims_Rustboro_WindyWater_VDests[timer_mod], 4 * 32);
}

static void QueueAnimTiles_Rustboro_Fountain(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_Rustboro_Fountain) / sizeof((gTilesetAnims_Rustboro_Fountain)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_Rustboro_Fountain[i], (u16 *)(0x06000000 + ((512 + 448) * 32)), 4 * 32);
}

static void QueueAnimTiles_Lavaridge_Lava(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_Lavaridge_Cave_Lava) / sizeof((gTilesetAnims_Lavaridge_Cave_Lava)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Cave_Lava[i], (u16 *)(0x06000000 + ((512 + 160) * 32)), 4 * 32);
}

static void QueueAnimTiles_EverGrande_Flowers(u16 timer_div, u8 timer_mod)
{
    timer_div -= timer_mod;
    timer_div %= (sizeof(gTilesetAnims_EverGrande_Flowers) / sizeof((gTilesetAnims_EverGrande_Flowers)[0]));

    AppendTilesetAnimToBuffer(gTilesetAnims_EverGrande_Flowers[timer_div], gTilesetAnims_EverGrande_VDests[timer_mod], 4 * 32);
}

static void QueueAnimTiles_Cave_Lava(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_Lavaridge_Cave_Lava) / sizeof((gTilesetAnims_Lavaridge_Cave_Lava)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Cave_Lava[i], (u16 *)(0x06000000 + ((512 + 416) * 32)), 4 * 32);
}

static void QueueAnimTiles_Dewford_Flag(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_Dewford_Flag) / sizeof((gTilesetAnims_Dewford_Flag)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_Dewford_Flag[i], (u16 *)(0x06000000 + ((512 + 170) * 32)), 6 * 32);
}

static void QueueAnimTiles_BattleFrontierOutsideWest_Flag(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_BattleFrontierOutsideWest_Flag) / sizeof((gTilesetAnims_BattleFrontierOutsideWest_Flag)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_BattleFrontierOutsideWest_Flag[i], (u16 *)(0x06000000 + ((512 + 218) * 32)), 6 * 32);
}

static void QueueAnimTiles_BattleFrontierOutsideEast_Flag(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_BattleFrontierOutsideEast_Flag) / sizeof((gTilesetAnims_BattleFrontierOutsideEast_Flag)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_BattleFrontierOutsideEast_Flag[i], (u16 *)(0x06000000 + ((512 + 218) * 32)), 6 * 32);
}

static void QueueAnimTiles_Slateport_Balloons(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_Slateport_Balloons) / sizeof((gTilesetAnims_Slateport_Balloons)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_Slateport_Balloons[i], (u16 *)(0x06000000 + ((512 + 224) * 32)), 4 * 32);
}
...
{
    u16 i = timer % (sizeof(gTilesetAnims_Building_TvTurnedOn) / sizeof((gTilesetAnims_Building_TvTurnedOn)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_Building_TvTurnedOn[i], (u16 *)(0x06000000 + ((496) * 32)), 4 * 32);
}

static void QueueAnimTiles_SootopolisGym_Waterfalls(u16 timer)
{
    u16 i = timer % min((sizeof(gTilesetAnims_SootopolisGym_SideWaterfall) / sizeof((gTilesetAnims_SootopolisGym_SideWaterfall)[0])), (sizeof(gTilesetAnims_SootopolisGym_FrontWaterfall) / sizeof((gTilesetAnims_SootopolisGym_FrontWaterfall)[0])));
    AppendTilesetAnimToBuffer(gTilesetAnims_SootopolisGym_SideWaterfall[i], (u16 *)(0x06000000 + ((512 + 496) * 32)), 12 * 32);
    AppendTilesetAnimToBuffer(gTilesetAnims_SootopolisGym_FrontWaterfall[i], (u16 *)(0x06000000 + ((512 + 464) * 32)), 20 * 32);
}

static void QueueAnimTiles_EliteFour_WallLights(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_EliteFour_WallLights) / sizeof((gTilesetAnims_EliteFour_WallLights)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_EliteFour_WallLights[i], (u16 *)(0x06000000 + ((512 + 504) * 32)), 1 * 32);
}

static void QueueAnimTiles_EliteFour_GroundLights(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_EliteFour_FloorLight) / sizeof((gTilesetAnims_EliteFour_FloorLight)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_EliteFour_FloorLight[i], (u16 *)(0x06000000 + ((512 + 480) * 32)), 4 * 32);
}

static void QueueAnimTiles_MauvilleGym_ElectricGates(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_MauvilleGym_ElectricGates) / sizeof((gTilesetAnims_MauvilleGym_ElectricGates)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_MauvilleGym_ElectricGates[i], (u16 *)(0x06000000 + ((512 + 144) * 32)), 16 * 32);
}

static void QueueAnimTiles_BikeShop_BlinkingLights(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_BikeShop_BlinkingLights) / sizeof((gTilesetAnims_BikeShop_BlinkingLights)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_BikeShop_BlinkingLights[i], (u16 *)(0x06000000 + ((512 + 496) * 32)), 9 * 32);
}

static void QueueAnimTiles_Sootopolis_StormyWater(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_Sootopolis_StormyWater) / sizeof((gTilesetAnims_Sootopolis_StormyWater)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_Sootopolis_StormyWater[i], (u16 *)(0x06000000 + ((512 + 240) * 32)), 96 * 32);
}

static void QueueAnimTiles_BattlePyramid_Torch(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_BattlePyramid_Torch) / sizeof((gTilesetAnims_BattlePyramid_Torch)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_BattlePyramid_Torch[i], (u16 *)(0x06000000 + ((512 + 151) * 32)), 8 * 32);
}

static void QueueAnimTiles_BattlePyramid_StatueShadow(u16 timer)
{
    u16 i = timer % (sizeof(gTilesetAnims_BattlePyramid_StatueShadow) / sizeof((gTilesetAnims_BattlePyramid_StatueShadow)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_BattlePyramid_StatueShadow[i], (u16 *)(0x06000000 + ((512 + 135) * 32)), 8 * 32);
}

static void BlendAnimPalette_BattleDome_FloorLights(u16 timer)
{
    CpuCopy16(sTilesetAnims_BattleDomeFloorLightPals[timer % (sizeof(sTilesetAnims_BattleDomeFloorLightPals) / sizeof((sTilesetAnims_BattleDomeFloorLightPals)[0]))], &gPlttBufferUnfaded[BG_PLTT_ID(8)], PLTT_SIZE_4BPP);
