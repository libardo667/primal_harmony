...
u16 *const gTilesetAnims_Mauville_Flower1_VDests[] = {
    (u16 *)(0x06000000 + 19456),
    (u16 *)(0x06000000 + 19584),
    (u16 *)(0x06000000 + 19712),
    (u16 *)(0x06000000 + 19840),
    (u16 *)(0x06000000 + 19968),
    (u16 *)(0x06000000 + 20096),
    (u16 *)(0x06000000 + 20224),
    (u16 *)(0x06000000 + 20352)
};
u16 *const gTilesetAnims_Mauville_Flower2_VDests[] = {
    (u16 *)(0x06000000 + 20480),
    (u16 *)(0x06000000 + 20608),
    (u16 *)(0x06000000 + 20736),
    (u16 *)(0x06000000 + 20864),
    (u16 *)(0x06000000 + 20992),
    (u16 *)(0x06000000 + 21120),
    (u16 *)(0x06000000 + 21248),
    (u16 *)(0x06000000 + 21376)
};
...
u16 *const gTilesetAnims_EverGrande_VDests[] = {
    (u16 *)(0x06000000 + 23552),
    (u16 *)(0x06000000 + 23680),
    (u16 *)(0x06000000 + 23808),
    (u16 *)(0x06000000 + 23936),
    (u16 *)(0x06000000 + 24064),
    (u16 *)(0x06000000 + 24192),
    (u16 *)(0x06000000 + 24320),
    (u16 *)(0x06000000 + 24448)
};
...
static void QueueAnimTiles_General_Flower(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_General_Flower[i], (u16 *)(0x06000000 + 16256), 4 * 32);
}
static void QueueAnimTiles_General_Water(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_General_Water[i], (u16 *)(0x06000000 + 13824), 30 * 32);
}
static void QueueAnimTiles_General_SandWaterEdge(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_General_SandWaterEdge[i], (u16 *)(0x06000000 + 14848), 10 * 32);
}
static void QueueAnimTiles_General_Waterfall(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_General_Waterfall[i], (u16 *)(0x06000000 + 15872), 6 * 32);
}
...
static void QueueAnimTiles_General_LandWaterEdge(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_General_LandWaterEdge[i], (u16 *)(0x06000000 + 15360), 10 * 32);
}
static void QueueAnimTiles_Lavaridge_Steam(u8 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Steam[i], (u16 *)(0x06000000 + 25600), 4 * 32);
    i = (timer + 2) % (int)(sizeof(gTilesetAnims_Lavaridge_Steam)/sizeof((gTilesetAnims_Lavaridge_Steam)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Steam[i], (u16 *)(0x06000000 + 25728), 4 * 32);
}
static void QueueAnimTiles_Pacifidlog_LogBridges(u8 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_Pacifidlog_LogBridges[i], (u16 *)(0x06000000 + 31232), 30 * 32);
}
static void QueueAnimTiles_Underwater_Seaweed(u8 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_Underwater_Seaweed[i], (u16 *)(0x06000000 + 32256), 4 * 32);
}
static void QueueAnimTiles_Pacifidlog_WaterCurrents(u8 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_Pacifidlog_WaterCurrents[i], (u16 *)(0x06000000 + 32256), 8 * 32);
}
...
static void QueueAnimTiles_Rustboro_Fountain(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_Rustboro_Fountain[i], (u16 *)(0x06000000 + 30720), 4 * 32);
}
static void QueueAnimTiles_Lavaridge_Lava(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Cave_Lava[i], (u16 *)(0x06000000 + 21504), 4 * 32);
}
...
{
    u16 i = timer % (sizeof(gTilesetAnims_Lavaridge_Cave_Lava)/sizeof((gTilesetAnims_Lavaridge_Cave_Lava)[0]));
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Cave_Lava[i], (u16 *)(0x06000000 + 29696), 4 * 32);
}
static void QueueAnimTiles_Dewford_Flag(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_Dewford_Flag[i], (u16 *)(0x06000000 + 21824), 6 * 32);
}
static void QueueAnimTiles_BattleFrontierOutsideWest_Flag(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_BattleFrontierOutsideWest_Flag[i], (u16 *)(0x06000000 + 23360), 6 * 32);
}
static void QueueAnimTiles_BattleFrontierOutsideEast_Flag(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_BattleFrontierOutsideEast_Flag[i], (u16 *)(0x06000000 + 23360), 6 * 32);
}
static void QueueAnimTiles_Slateport_Balloons(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_Slateport_Balloons[i], (u16 *)(0x06000000 + 23552), 4 * 32);
}
...
static void QueueAnimTiles_Building_TVTurnedOn(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_Building_TvTurnedOn[i], (u16 *)(0x06000000 + 15872), 4 * 32);
}
static void QueueAnimTiles_SootopolisGym_Waterfalls(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_SootopolisGym_SideWaterfall[i], (u16 *)(0x06000000 + 32256), 12 * 32);
    AppendTilesetAnimToBuffer(gTilesetAnims_SootopolisGym_FrontWaterfall[i], (u16 *)(0x06000000 + 31232), 20 * 32);
}
static void QueueAnimTiles_EliteFour_WallLights(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_EliteFour_WallLights[i], (u16 *)(0x06000000 + 32512), 1 * 32);
}
static void QueueAnimTiles_EliteFour_GroundLights(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_EliteFour_FloorLight[i], (u16 *)(0x06000000 + 31744), 4 * 32);
}
static void QueueAnimTiles_MauvilleGym_ElectricGates(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_MauvilleGym_ElectricGates[i], (u16 *)(0x06000000 + 20992), 16 * 32);
}
static void QueueAnimTiles_BikeShop_BlinkingLights(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_BikeShop_BlinkingLights[i], (u16 *)(0x06000000 + 32256), 9 * 32);
}
static void QueueAnimTiles_Sootopolis_StormyWater(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_Sootopolis_StormyWater[i], (u16 *)(0x06000000 + 24064), 96 * 32);
}
static void QueueAnimTiles_BattlePyramid_Torch(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_BattlePyramid_Torch[i], (u16 *)(0x06000000 + 21216), 8 * 32);
}
static void QueueAnimTiles_BattlePyramid_StatueShadow(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_BattlePyramid_StatueShadow[i], (u16 *)(0x06000000 + 20704), 8 * 32);
}
static void BlendAnimPalette_BattleDome_FloorLights(u16 timer)
{
    CpuCopy16(sTilesetAnims_BattleDomeFloorLightPals[timer % (sizeof(sTilesetAnims_BattleDomeFloorLightPals)/sizeof((sTilesetAnims_BattleDomeFloorLightPals)[0]))], &gPlttBufferUnfaded[BG_PLTT_ID8], PLTT_SIZE_4BPP);
    BlendPalette(BG_PLTT_ID8, 16, gPaletteFade.y, gPaletteFade.blendColor & 0x7FFF);
